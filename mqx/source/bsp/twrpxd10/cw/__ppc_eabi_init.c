...
#include "MPXD10_cw.h"
#define FLASH_REG CFLASH0.PFCR0.R
#define FLASH_DATA 0x108593FD
#define FLASH_REG2 CFLASH1.PFCR0.R
#define FLASH_DATA2 0x108593FD

/* Force call user_init() function */
...
asm void __init_user(void)
{
   ...
   */
   /*bl ClockInit ; leave this clock init to init_bsp.c */
