...
const TASK_TEMPLATE_STRUCT  MQX_template_list[] = 
{
	...
	{ SHELL_SERVER_TASK,            shell_server_task,          4000,   11,           "shell server task",              0,                      0,     0 },
	...
	{ UDP_CONNECT_TASK1,            udp_connect_task1, 	        5000,   16,           "udp connect task1",              0,    0,     0 },
	{ UDP_CONNECT_TASK2,            udp_connect_task2, 	        5000,   16,           "udp connect task2",              0,    0,     0 },
	{ UDP_CONNECT_TASK3,            udp_connect_task3, 	        5000,   16,           "udp connect task3",              0,    0,     0 },
	{ 0 }
};
